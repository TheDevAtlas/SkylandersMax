...
void HavokMaxV2::SetMotionIndex(int32 i)
{
    motionIndex = i;
}

//void HavokMaxV1::SetMotionIndex(int32 i)
//{
//    motionIndex = i;
//}
...
void HavokMaxV2::UpdatePresetUI(PresetData &data) {
  ...
  motionIndex++;// this will work with the window opening, but sadly you need to press the button EVERY time an animation is added.

  // Need to find a way to automagically close the window when the loop happens //
